...
export default function ScrollProgress() {
  ...
  return (
    <div className="hidden lg:flex fixed bottom-8 right-8 z-40 font-mono text-[8px] md:text-xs mix-blend-difference text-gray-500 flex-col items-end leading-none gap-0.5">
